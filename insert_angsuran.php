...
if(isset($_POST['simpan'])){
    ...
    if($kode_pinjaman && $id_anggota && $id_petugas &&  $tanggal_pembayaran && $angsuran_ke && $jumlah){
        ...
        if ($q1) {
            $sukses = "Selamat Kamu Berhasil Melakukan Angsuran ke $angsuran_ke dengan Kode Pinjaman $kode_pinjaman";
        }else {
    ...
    <div id="page-content-wrapper">
      <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
        <div class="d-flex align-items-center">
          ...
          <h2 class="fs-2 m-0">Dashboard Angsuran</h2>
        </div>
      </nav>
            ...
            ?>
                ...
                <div class="row d-flex justify-content-between">
                    <div class="col-12 d-flex justify-content-end justify-content-between">
                        ...
                        <input type="submit" name="simpan" value="Angsur" class="btn btn-primary">
                    </div>
                </div>
            </form>
        </div>
